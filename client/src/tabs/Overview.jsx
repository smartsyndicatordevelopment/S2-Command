...
const GREETING = "Hi Brandon. I'm your business analyst -- connected live to Stripe, QuickBooks, Facebook Ads, GHL, and Make. Ask me anything about MRR, revenue, expenses, ad performance, your pipeline, or automations. I pull live data before answering.";
    ...
    <div className="flex flex-col" style={{ height: 'calc(100vh - 116px)' }}>
      <div className="mb-4 flex-shrink-0">
        ...
        <p className="text-xs mt-0.5" style={{ color: 'var(--c-muted)' }}>
          Ask your business analyst anything -- live data across Stripe, QuickBooks, Facebook Ads, GHL, and Make
        </p>
      </div>
