    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-5 gap-4">
        ...
        <StatCard
          ...
          accent="white"
          tooltip={`The average total revenue generated by a customer over their entire relationship with the business.\nTotal all-time paid invoices ÷ ${totalEverCount} unique customers`}
          loading={subs.loading}
        />
        <StatCard
          ...
          tooltip={qbConfigured
            ? marketingAccounts.length > 0
              ? `How much it costs on average to acquire one new paying customer, based on the last 90 days of marketing spend.\n${fmtMrr(spend3m)} marketing spend ÷ ${newCustomersLast3m} new customers\nAccounts: ${marketingAccounts.join(', ')}`
              : `How much it costs on average to acquire one new paying customer.\nNo marketing/advertising QB accounts found in the last 90 days`
