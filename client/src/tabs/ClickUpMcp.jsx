...
const GREETING = "Hi! I'm connected to your ClickUp workspace. Ask me about tasks, projects, goals, time tracking, or team activity -- I can also create and update records for you.";
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 116px)' }}>
      ...
      {hasKey === false && (
        ...
        >
          CLICKUP_API_KEY is not set. Add it to your Railway environment variables to enable this assistant.
        </div>
      )}
      ...
      <div className="flex gap-2 flex-shrink-0">
        <textarea
          ...
          placeholder={
            hasKey === false
              ? 'Configure CLICKUP_API_KEY in Railway to start'
              : 'Ask anything about your ClickUp workspace... (Enter to send, Shift+Enter for new line)'
          }
